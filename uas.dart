...
class App13 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Adventus - 5SIA1',
      home: Adventus_5sia1(),
    );
  }
}

class Adventus_5sia1 extends StatefulWidget {
  MyTabsState createState() => new MyTabsState();
}

class MyTabsState extends State<Adventus_5sia1>
...
class Penjualan extends StatelessWidget {
  ...
  final List<Transaksi> transaksi = [
    Transaksi(pelanggan: "Adventus", barang: "Sepatu", jumlah: 2, harga: 300000),
    Transaksi(pelanggan: "Elida", barang: "Tali jemuran", jumlah: 3, harga: 9000),
    Transaksi(pelanggan: "Pardamean", barang: "Laptop Asus", jumlah: 1, harga: 12000000),
  ];
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              accountName: Text('Adventus Trifanly Rajagukguk'),
              accountEmail: Text('adventustrifanly99@gmail.com'),
              currentAccountPicture: Image.network(
                  'https://scontent.fkno3-1.fna.fbcdn.net/v/t1.0-9/47363881_2277681552516620_752799550992809984_o.jpg?_nc_cat=107&ccb=2&_nc_sid=09cbfe&_nc_ohc=FXIPhbbysUkAX8kUG2L&_nc_ht=scontent.fkno3-1.fna&oh=3ac6815fe9f86df9d613289811d5d8ae&oe=6000AADB'),
